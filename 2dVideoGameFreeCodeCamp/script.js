window.addEventListener('load', function () {
    ...
    class Player {
        ...
        shootBottom() {
            if (this.game.amno > 0) {
                this.proyectiles.push(new Proyectile(this.game, this.x + 80, this.y + 175));
            }
        }
    ...
    class Drone extends Enemy {
        constructor(game, x, y) {
            ...
            this.frameY = Math.floor(Math.random() * 2);
            this.type = 'drone';
            this.speedX = Math.random() * -2.2 - 0.5;
    ...
    class UI {
        ...
        draw(context) {
            ...
            //toFixed es para generar la cantidad de decimales que queremos mostrar
            ...
            for (let i = 0; i < this.game.amno; i++) {
    ...
    class Game {
        ...
        update(deltaTime) {
            ...
            this.particles.filter(particles => !particles.markedForDeletion);
        ...
        addExplosion(enemies) {
            const randomize = Math.random();
            if (randomize < 0.5) {
                this.explosions.push(new SmokeExplosion(this, enemies.x + enemies.width * 0.5, enemies.y + enemies.height * 0.5));
            } else {
                this.explosions.push(new FireExplosion(this, enemies.x + enemies.width * 0.5, enemies.y + enemies.height * 0.5));
            }
